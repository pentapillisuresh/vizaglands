            ...
            {residentialCategories.map((cat, idx) => (
              ...
              >
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-500 group-hover:-translate-y-3 group-hover:shadow-2xl flex flex-col h-full border border-gray-200 hover:border-orange-200">
                  ...
                  <div className="px-5 py-6 text-center flex flex-col flex-grow justify-center">
                    <h3 className="text-sm font-serif font-bold text-gray-900 group-hover:text-orange-600 transition-colors duration-300 mb-2">
                      {cat.name}
                    </h3>
                    <span className="inline-block bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs font-medium uppercase tracking-wide group-hover:bg-orange-50 group-hover:text-orange-600 transition-all duration-300">
                      {cat.catType}
                    </span>
                  </div>
                </div>
            ...
            {commercialCategories.map((cat, idx) => (
              ...
              >
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-500 group-hover:-translate-y-3 group-hover:shadow-2xl flex flex-col h-full border border-gray-200 hover:border-blue-200">
                  ...
                  {/* Content Section - Fixed Height */}
                  <div className="px-5 py-6 text-center flex flex-col flex-grow justify-center">
                    <h3 className="text-sm font-serif font-bold text-gray-900 group-hover:text-blue-600 transition-colors duration-300 mb-2">
                      {cat.name}
                    </h3>
                    <span className="inline-block bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs font-medium uppercase tracking-wide group-hover:bg-blue-50 group-hover:text-blue-600 transition-all duration-300">
                      {cat.catType}
                    </span>
                  </div>
                </div>
